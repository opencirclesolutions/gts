...
import $cssFromFile_2 from 'Frontend/generated/jar-resources/styles/enhanced-form-layout.css?inline';
const $css_2 = typeof $cssFromFile_2  === 'string' ? unsafeCSS($cssFromFile_2) : $cssFromFile_2;
registerStyles('vaadin-form-layout', $css_2, {moduleId: 'flow_css_mod_2'});
import $cssFromFile_3 from 'Frontend/themes/my-theme/vaadin-custom-field.css?inline';
const $css_3 = typeof $cssFromFile_3  === 'string' ? unsafeCSS($cssFromFile_3) : $cssFromFile_3;
registerStyles('vaadin-custom-field', $css_3, {moduleId: 'flow_css_mod_3'});
import $cssFromFile_4 from 'Frontend/themes/my-theme/vaadin-button.css?inline';
const $css_4 = typeof $cssFromFile_4  === 'string' ? unsafeCSS($cssFromFile_4) : $cssFromFile_4;
registerStyles('vaadin-button', $css_4, {moduleId: 'flow_css_mod_4'});
import $cssFromFile_5 from 'Frontend/themes/my-theme/vaadin-dialog.css?inline';
const $css_5 = typeof $cssFromFile_5  === 'string' ? unsafeCSS($cssFromFile_5) : $cssFromFile_5;
registerStyles('vaadin-dialog', $css_5, {moduleId: 'flow_css_mod_5'});
import $cssFromFile_6 from 'Frontend/themes/my-theme/vaadin-grid.css?inline';
const $css_6 = typeof $cssFromFile_6  === 'string' ? unsafeCSS($cssFromFile_6) : $cssFromFile_6;
registerStyles('vaadin-grid', $css_6, {moduleId: 'flow_css_mod_6'});
import $cssFromFile_7 from 'Frontend/themes/my-theme/vaadin-menu-bar.css?inline';
